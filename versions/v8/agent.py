...
Opening: book/gm2001.bin, a Polyglot book of grandmaster games from 2001 to 2013 with both players
rated 2530 or more, compiled by Oliver Deville. Its highest weighted move is played without search.
"""
...
BOOK_PATH = Path(__file__).resolve().parent / "book" / "gm2001.bin"
...
BOOK = _open_book()
print(f"opening book: {'gm2001' if BOOK else 'none (no book file)'}", flush=True)
