...
# The network scores in Stockfish's internal units, which it normalises at 328 to a pawn. The
# search's pruning margins were set against the hand-written evaluation, pawn = 100; fitted over
# 449 opening positions the trained net needed 0.30, and 100 / 328 = 0.305.
TO_CENTIPAWNS = 100.0 / 328.0
